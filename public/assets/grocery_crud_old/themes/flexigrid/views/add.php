...
<?php } ?>
        ...
        <div class="form-actions" style="margin-left:20px; margin-top:-20px">
            <div class='form-button-box'>
                <input class='btn btn-primary' id="form-button-save" type='submit' value='<?php echo $this->l('form_save'); ?>'/>
            </div>
<?php if (!$this->unset_back_to_list) { ?>
                <div class='form-button-box'>
                    <input class='btn btn-darkblue' type='button' value='<?php echo $this->l('form_save_and_go_back'); ?>' id="save-and-go-back-button"/>
                </div>
                <div class='form-button-box'>
                    <input class='btn btn-danger ' type='button' value='<?php echo $this->l('form_cancel'); ?>' id="cancel-button" />
                </div>
<?php } ?>
            <div class='form-button-box'>
