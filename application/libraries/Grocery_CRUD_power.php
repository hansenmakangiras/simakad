            ...
            case 'upload_file':
                if (empty($value)) {
                    ...
                    $is_image = !empty($value) &&
                            ( substr(strtolower($value), -4) == '.jpg' || substr(strtolower($value), -4) == '.png' || substr(strtolower($value), -5) == '.jpeg' || substr(strtolower($value), -4) == '.gif' || substr(strtolower($value), -5) == '.tiff') ? true : false;
